...
const WebIntern = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://n-technologies-backend.onrender.com/api/web-intern",
        {
          method: "POST",
          body: data,
        }
  ...
  return (
    <div className="frontend-form-wrapper">
      ...
      <p>
        We are hiring creative frontend developers for an internship role. Work
        with React.js, HTML, CSS, and modern UI/UX practices to build
        ...
        <div className="frontend-internship-form">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              type="text"
              name="project"
              placeholder="Enter the link of major project"
              onChange={handleChange}
              required
            />
            <input
